...
export const TracingBeam = ({
  ...
  return (
    ...
    >
      <div className="absolute -left-4 md:-left-12 top-3 z-0">
        <motion.div
          transition={{ duration: 0.2, delay: 0.5 }}
          animate={{
            boxShadow: scrollYProgress.get() > 0 ? "none" : "rgba(0, 0, 0, 0.24) 0px 3px 8px",
          }}
          className="ml-[11px] h-4 w-4 rounded-full border border-neutral-700 shadow-sm flex items-center justify-center"
        >
          <motion.div
            transition={{ duration: 0.2, delay: 0.5 }}
            animate={{
      ...
      <div ref={contentRef} className="ml-10">
        {children}
      </div>
    </motion.div>
  );
